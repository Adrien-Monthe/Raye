        ...
        <div class="row justify-content-center">
            <div class="col-xl-11">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="team2" role="tabpanel">
                                <div class="team-box">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title"><a href="#">Johnson John</a></h3>
                                        <div class="group-count"><span>25</span> - Fashion</div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="team3" role="tabpanel">
                                <div class="team-box">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title"><a href="#">Fahim Rahman</a></h3>
                                        <div class="group-count"><span>25</span> - Fashion</div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="team4" role="tabpanel">
                                <div class="team-box">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title"><a href="#">Mamunur Rashid</a></h3>
                                        <div class="group-count"><span>25</span> - Fashion</div>
                                    </div>
                                </div>
                            </div>
                ...
                <ul class="shape-wrap">
                    ...
                    <li><img src="{{ asset('website/media/team/shape_1.png')}}" alt="shape"></li>
                    <li><img src="{{ asset('website/media/team/shape_2.png')}}" alt="shape"></li>
                    <li><img src="{{ asset('website/media/team/shape_circle_1.png')}}" alt="shape"></li>
                    <li><img src="{{ asset('website/media/team/shape_circle_2.png')}}" alt="shape"></li>
                    <li><img src="{{ asset('website/media/team/shape_circle_3.png')}}" alt="shape"></li>
                    <li><img src="{{ asset('website/media/team/shape_3.png')}}" alt="shape"></li>
                    <li><img src="{{ asset('website/media/team/shape_4.png')}}" alt="shape"></li>
                </ul>
            </div>
        </div>
        <div class="see-all-btn">
            <a href="forums-members.html" class="button-slide">
