        ...
        <div class="row no-gutters">
            <div class="col-lg-6">
                <div class="why-choose-content">
                    <div class="content-box">
                        <h2 class="item-title">Trip Story Makes Your Life Easier &amp; Simple</h2>
                        ...
                        <a href="about-us.html" class="button-slide">
            ...
            <div class="col-lg-6">
                <div class="why-choose-img">
                    <div class="image-box">
                        <img src="{{ asset('website/media/figure/why_choose_2.jpg')}}" alt="image">
                    </div>
                </div>
            </div>
        </div>
